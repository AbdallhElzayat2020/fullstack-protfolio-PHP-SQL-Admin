...
//          $res = AddNewPro($filename , $desc , $uder_id);
     ...
     $data = GetProtfiolio_Id($_GET['proid']);
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    ...
                    <!-- form start -->
                    <form role="form" action="updateProtfolio.php" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="form-group">
                                <textarea name="desc" id="summernote" placeholder="textHere"
                                          class="form-control"><?= $data['description'] ?></textarea>
                            </div>
                            <img src="upload/<?= $data['img'] ?>" style=" width: 200px ; height: 200px" alt="img_pro">
                            <div class="form-group">
